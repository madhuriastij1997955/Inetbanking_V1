...
import com.ibanking.TestCases.BaseClass;

public class ReportGen extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext)
	{
		...
		extent.setSystemInfo("user","madhuri");
	...
	public void onTestFailure(ITestResult tr)
	{
		...
		String path="./Screenshots/"+tr.getName()+".png";
		   try {
			logger.fail("the screenshot bellow is"+ logger.addScreenCaptureFromPath(path));
		} catch (IOException e) {
